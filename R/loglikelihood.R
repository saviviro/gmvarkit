...
#'         \item{\strong{If \eqn{W} is constrained:}}{Remove the zeros from \eqn{vec(W)} and make sure the other components satisfy
...
#'   error term covariance matrices (see Virolainen, 2020).
