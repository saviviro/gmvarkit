...
#' A quarterly U.S. data covering the period from 1954Q3 to 2021Q1 (267 observations) and consisting four variables:
...
#'
#' @format A numeric matrix of class \code{'ts'} with 267 rows and 4 columns with one time series in each column:
#' \describe{
