...
set.seed(1)
pred222 <- predict.gmvar(mod_222, n_ahead=2, n_simu=10, ci=c(0.95, 0.80), plot_res=FALSE)
...
test_that("predict works correctly", {
   ...
   expect_equal(pred222$conf_ints[[1]][2,], c(-4.774, 138.032), tolerance=1e-3)
   expect_equal(pred222$conf_ints[[4]][1,], c(5.028166, 147.636413), tolerance=1e-3)

   expect_equal(pred123$pred[1,], c(-9.3293117, -0.4367334, 10.6762769), tolerance=1e-5)
   expect_equal(pred123$conf_ints[[1]][1,], c(-7.976158, 1.307586, 11.744568), tolerance=1e-5)
