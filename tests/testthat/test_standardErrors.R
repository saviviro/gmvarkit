...
test_that("standard_errors works correctly", {
  expect_equal(standard_errors(data, p=2, M=2, params=theta_222c, conditional=TRUE, parametrization="intercept",
               ...
               c(0.57323112, 1.42708542, 0.68407209, 1.79850113, 0.06503308, 0.09518451, 0.03464635, 0.06118081,
                 0.06339426, 0.09592758, 0.03487118, 0.06453526, 0.15615508, 0.27195919, 0.72882509, 0.72951956,
                 0.73219670, 1.18963949, 0.28865116), tolerance=1e-4)
  expect_equal(standard_errors(data, p=2, M=2, params=theta_222_c2, conditional=TRUE, parametrization="intercept",
               ...
               c(NA, 0.78872941, NA, 0.92849143, 0.05692548, 0.05744037, 0.05888322, 0.05761173, NA, NA, 0.85622084,
                 0.68689890, 0.72052650, 1.16661586, 0.40045562), tolerance=1e-4)
})
